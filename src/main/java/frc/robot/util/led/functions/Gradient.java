...
public class Gradient implements DoubleFunction<Color> {
    ...
    private final Supplier<Color[]> colors;
    ...
    public static enum InterpolationStyle implements InterpolationFunction<Color> {
        ...
        public Gradient gradient(Color... colors) {
            return new Gradient(this, colors);
        }
        public Gradient gradient(Supplier<Color[]> colors) {
            return new Gradient(this, colors);
        }
    }

    public Gradient(InterpolationFunction<Color> interpolationFunction, Color... colors) {
        this(interpolationFunction, () -> colors);
    }
    public Gradient(InterpolationFunction<Color> interpolationFunction, Supplier<Color[]> colors) {
        this.colors = colors;
    ...
    public Color apply(double x) {
        return interpolationFunction.interpolate(x, colors.get());
    }
}
